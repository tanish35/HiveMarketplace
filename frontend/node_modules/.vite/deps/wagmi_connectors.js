import {
  ...
  injected,
  mock
} from "./chunk-XGFO727V.js";
import "./chunk-RJHKLZND.js";
import "./chunk-LWLUVSGB.js";
import {
  withRetry,
  withTimeout
} from "./chunk-GZI6LZT5.js";
import "./chunk-MB6T4TI3.js";
import "./chunk-HUEXZF57.js";
import "./chunk-R5EZQYSA.js";
import "./chunk-NICVCX3X.js";
import {
  ...
  hexToNumber,
  numberToHex
} from "./chunk-L3B6MNH7.js";
import "./chunk-PUDE25F6.js";
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      if (!walletProvider) {
        ...
        const { createCoinbaseWalletSDK } = await import("./dist-ICJIZHSR.js");
    ...
    async getProvider() {
      ...
      if (!walletProvider) {
        const CoinbaseWalletSDK = await (async () => {
          const { default: SDK } = await import("./dist-23TQTDLJ.js");
    ...
    async getProvider() {
      async function initProvider() {
        ...
        const MetaMaskSDK = await (async () => {
          const { default: SDK } = await import("./metamask-sdk-6AK5HYX4.js");
          if (typeof SDK !== "function" && typeof SDK.default === "function")
            return SDK.default;
          return SDK;
        })();
  ...
  return createConnector((config) => ({
    ...
    async getProvider() {
      ...
      if (!isIframe)
        return;
      if (!provider_) {
        const { default: SDK } = await import("./esm-P6TTR6U4.js");
        ...
        const SafeAppProvider = await (async () => {
          const Provider = await import("./dist-CUERNGWK.js");
    ...
    async getProvider({ chainId } = {}) {
      ...
      async function initProvider() {
        ...
        if (!optionalChains.length)
          return;
        const { EthereumProvider } = await import("./index.es-YCXSEV52.js");
